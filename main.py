...
class MonopolyGame:
    ...
    def __init__(self):
        ...
        # UI元素
        self.roll_button = pygame.Rect(INFO_PANEL_X, 400, BUTTON_WIDTH, BUTTON_HEIGHT)
        self.buy_button = pygame.Rect(INFO_PANEL_X, 460, BUTTON_WIDTH, BUTTON_HEIGHT)
        self.skip_button = pygame.Rect(INFO_PANEL_X, 520, BUTTON_WIDTH, BUTTON_HEIGHT)
        self.end_turn_button = pygame.Rect(INFO_PANEL_X, 580, BUTTON_WIDTH, BUTTON_HEIGHT)
    ...
    def run(self):
        ...
        while running:
            ...
            if not self.game_manager.game_over:
                ...
                if current_player.is_ai and not self.game_manager.waiting_for_buy_decision:
    ...
    def render(self):
        ...
        self.renderer.draw_info_panel(self.game_manager.ai_player, INFO_PANEL_X, 200)
        
        # 绘制消息
        self.renderer.draw_messages(self.game_manager.messages, 50, 550)
